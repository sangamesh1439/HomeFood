...
class UpdateTodaysMenuComponent extends React.Component {
    state = {
        emailId: '',
        password: ''
    }
        ...
        return (
            <View style={{ flex: 1, backgroundColor:"black", justifyContent: "center", alignItems: "center" }}>
                ...
                <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                    ...
                    }} status='success'>User UpdateTodaysMenu </Button>
                ...
                <Button style={{ margin: 10, backgroundColor: colors.GREEN }} onPress={() => {
                    ...
                    }} status='success'>House Wife UpdateTodaysMenu </Button>
...
export const UpdateTodaysMenu = UpdateTodaysMenuComponent